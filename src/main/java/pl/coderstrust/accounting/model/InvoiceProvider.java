...
public class InvoiceProvider {
  public Invoice InvoiceOne(){
    ...
    Invoice invoice = new Invoice(0L, "FV 1/2017", LocalDate.of(2017,10,2), buyer, seller,Arrays.asList(invoiceEntry));
    return invoice;
  }
  public Invoice InvoiceTwo(){
    ...
    Invoice invoice = new Invoice(1L, "FV 1/2018", LocalDate.of(2018,2,2), buyer, seller, Arrays.asList(one, two));
    return invoice;
  }
  public Invoice InvoiceThree(){
    ...
    Invoice invoice = new Invoice(2L, "FV 2/2018", LocalDate.of(2018,3,2), buyer, seller,entries);
    return invoice;
  }
